    ...
    <div className="min-h-screen text-white font-sans">
      <div className="mx-auto">
        <div className="relative h-screen w-screen flex items-center justify-center overflow-hidden">
          ...
          />
          <Card className="relative w-[80%] lg:w-[30%] z-20 px-4 py-6 gap-4 bg-sidebar-group border-[2px] border-sidebar-border rounded-lg text-sidebar-text flex flex-col align-center items-center">
