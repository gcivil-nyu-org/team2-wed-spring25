...
export default function LocationSearchForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 p-4 bg-white rounded-lg shadow-md space-y-4 md:pt-4 md:pb-4 md:pl-4 md:pr-4 sm:pt-3 sm:pb-3 sm:pl-3 sm:pr-3 pt-2 pb-2 pl-2 pr-2">
      {formError && (
      ...
      <Button
        ...
        className="w-full mt-4 bg-map-pointer hover:bg-map-pointer2 text-map-legendtext text-sm md:text-base sm:text-xs p-2 sm:p-1.5"
      >
        {getButtonText()}
      </Button>
