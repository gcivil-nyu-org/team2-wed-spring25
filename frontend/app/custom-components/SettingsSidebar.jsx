...
const items = [
  ...
  { title: "Location Settings", url: "/users/settings/profile#location", icon: Globe },
...
const routeItems = [
  { title: "Saved Routes", url: "/users/settings/routes#saved", icon: MapPinPlus },
  { title: "Route Preferences", url: "/users/settings/routes#preferences", icon: MapPinCheck },
  { title: "Route History", url: "/users/settings/routes#history", icon: MapPinned },
];

const forumItems = [
  { title: "Posts", url: "/users/settings/forum/posts", icon: MessageSquareDiff },
  { title: "Comments", url: "/users/settings/forum/comments", icon: MessageSquareText },
  { title: "Reactions", url: "/users/settings/forum/reactions", icon: ThumbsUp },
  { title: "Reported Posts", url: "/users/settings/forum/reports", icon: ClipboardX },
];
      ...
      <SidebarContent className="p-0">
        ...
        <SidebarHeader className="border-b border-sidebar-border border-opacity-30 bg-sidebar-bg shadow-sm sticky top-0 z-50">
          <div className="relative flex justify-center items-center py-0">
            <div className="absolute left-4 cursor-pointer text-sidebar-text hover:text-white transition-colors duration-200">
              <ArrowRight
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-medium text-sidebar-text">Settings</h1>
            </div>
          </div>
        </SidebarHeader>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                className={`rounded-md py-3 px-4 bg-red-700 hover:bg-red-800 transition-colors duration-100 text-white w-full ${isLoggingOut ? 'opacity-70 cursor-not-allowed' : ''
                  }`}
              >
