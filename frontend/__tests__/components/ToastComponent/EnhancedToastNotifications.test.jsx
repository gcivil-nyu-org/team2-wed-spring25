...
// Mock window.undefined to test SSR conditions
  ...
  return (
    <div>
      ...
      <button 
        ...
        onClick={() => showError('Error with string details', 'This is a detailed error message', 'api')}
      >
      ...
      <button 
        ...
        onClick={() => showError('Error with Error object', new Error('Error object details'), 'api')}
      >
      ...
      <button 
        ...
        onClick={() => showError('Error with object details', { code: 500, message: 'Server error', stack: 'Error stack trace...' }, 'api')}
      >
      ...
      <button 
        ...
        onClick={() => showWarning('Warning with string details', 'This is a detailed warning message', 'routing_issue')}
      >
      ...
      <button 
        ...
        onClick={() => showWarning('Warning with Error object', new Error('Warning object details'), 'routing_issue')}
      >
      ...
      <button 
        ...
        onClick={() => showWarning('Warning with object details', { code: 404, message: 'Not found', details: 'Additional info...' }, 'routing_issue')}
      >
      ...
      <button 
        ...
        onClick={() => {
          const circularObj = {};
          circularObj.self = circularObj; // Create circular reference
          showWarning('Warning with invalid details', circularObj, 'routing_issue');
        }}
      >
...
describe('ToastNotifications with Details', () => {
  ...
  afterEach(() => {
    restoreWindow(); // Ensure window is restored after each test
  });
  
  test('should handle server-side rendering when window is undefined', () => {
    mockWindow(); // Remove window object to simulate SSR
  ...
  test('should handle complex object details for errors', () => {
    ...
    // After clicking "Details", expect to see the JSON string of the object
    expect(toast.error).toHaveBeenCalledWith(
      'Error Details',
      expect.objectContaining({
