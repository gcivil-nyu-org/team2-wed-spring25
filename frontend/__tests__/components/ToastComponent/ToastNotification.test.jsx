  ...
  return (
    <div>
      <button
        ...
        onClick={() => showError("Error message", "Error details", "api")}
      >
        Trigger Error
      </button>
      <button
        data-testid="trigger-error-token"
        onClick={() => showError("Token error", null, "token")}
      >
        Trigger Token Error
      </button>
      <button
        data-testid="trigger-error-login"
        onClick={() => showError("Login error", null, "login")}
      >
        Trigger Login Error
      </button>
      <button
        data-testid="trigger-error-permission"
        onClick={() => showError("Permission error", null, "permission")}
      >
        Trigger Permission Error
      </button>
      <button
        data-testid="trigger-error-map"
        onClick={() => showError("Map error", null, "map_initialization_error")}
      >
        Trigger Map Error
      </button>
      <button
        data-testid="trigger-error-route"
        onClick={() => showError("Route error", null, "route_fetch_error")}
      >
        Trigger Route Error
      </button>
      ...
      <button
        ...
        onClick={() =>
          showWarning("Warning message", "Warning details", "routing_issue")
        }
      >
        Trigger Warning
      </button>
      <button
        data-testid="trigger-warning-location"
        onClick={() =>
          showWarning("Location warning", null, "location_outside_nyc")
        }
      >
        Trigger Location Warning
      </button>
      <button
        data-testid="trigger-warning-permission"
        onClick={() =>
          showWarning(
      ...
      <button
        data-testid="trigger-warning-map"
        onClick={() => showWarning("Map data warning", null, "map_data")}
      >
      ...
      <button
        ...
        onClick={() => showSuccess("Success message", null, "login")}
      >
        Trigger Success
      </button>
      <button
        data-testid="trigger-success-signup"
        onClick={() => showSuccess("Signup success", null, "signup")}
      >
        Trigger Signup Success
      </button>
      <button
        data-testid="trigger-success-profile"
        onClick={() => showSuccess("Profile success", null, "profile")}
      >
        Trigger Profile Success
      </button>
      <button
        data-testid="trigger-success-route"
        onClick={() => showSuccess("Route success", null, "route_found")}
      >
