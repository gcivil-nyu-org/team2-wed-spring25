...
describe("SavedRoutesList", () => {
  ...
  it("should display empty state when no routes are available", async () => {
    ...
    expect(
      screen.getByText("You haven't saved any routes yet.")
    ).toBeInTheDocument();
  });
  ...
  it("should toggle favorite status when star button is clicked", async () => {
    ...
    expect(authAPI.authenticatedPatch).toHaveBeenCalledWith("/update-route/", {
      id: 1,
      favorite: true,
    });
  ...
  it("should open delete dialog when delete button is clicked", async () => {
    ...
    expect(
      screen.getByText(
        'Are you sure you want to delete "Route 1"? This action cannot be undone.'
      )
    ).toBeInTheDocument();
    ...
    expect(
      screen.queryByText('Are you sure you want to delete "Route 1"?')
  ...
  it("should delete route when confirmed in dialog", async () => {
    ...
    expect(authAPI.authenticatedDelete).toHaveBeenCalledWith(
      "/delete-route/1/"
    );
