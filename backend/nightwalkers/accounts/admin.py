...
class CustomUserAdmin(UserAdmin):
    ...
    def get_followers_count_display(self, obj):
        ...
        return format_html(
            '<a href="{}?followers__id__exact={}">{}</a>', url, obj.id, count
        )
    ...
    def get_following_count_display(self, obj):
        ...
        return format_html(
            '<a href="{}?following__id__exact={}">{}</a>', url, obj.id, count
        )
    ...
    def verify_email(self, request, queryset):
        ...
        self.message_user(
            request, f"{updated} users have been marked as email verified."
        )
...
class FollowAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        ...
        "following_user__first_name",
        "following_user__last_name",
    )
    ...
    def get_queryset(self, request):
        return (
            super().get_queryset(request).select_related("main_user", "following_user")
        )
