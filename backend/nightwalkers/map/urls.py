...
urlpatterns = [
    ...
    path("map/heatmap-data/primary/", PrimaryHeatmapDataView.as_view(), name="primary-heatmap"),
    path("map/heatmap-data/secondary/", SecondaryHeatmapDataView.as_view(), name="secondary-heatmap"),
